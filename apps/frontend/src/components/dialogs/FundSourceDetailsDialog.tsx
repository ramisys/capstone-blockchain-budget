...
interface FundSourceDetailsDialogProps {
  isOpen: boolean;
  onClose: () => void;
  fundSourceId: string;
  initialData: any; // Ideally typed as FundSource
}

const FundSourceDetailsDialog: React.FC<FundSourceDetailsDialogProps> = ({
  isOpen,
  onClose,
  fundSourceId,
  initialData
...
export { FundSourceDetailsDialog };
export default FundSourceDetailsDialog;
