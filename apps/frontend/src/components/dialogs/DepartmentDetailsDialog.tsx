...
interface DepartmentDetailsDialogProps {
  ...
  onClose: () => void;
  departmentId: string;
  initialData: any; // Ideally typed as Department
}

const DepartmentDetailsDialog: React.FC<DepartmentDetailsDialogProps> = ({
  isOpen,
  onClose,
  departmentId,
  initialData
          ...
          <div className="space-y-4">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
              <div className="space-y-1">
                <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Office Head</p>
                <p className="text-sm font-semibold text-slate-900">
                  {initialData.officeHead || 'N/A'}
                </p>
              </div>

              <div className="space-y-1">
                <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Contact Number</p>
                <p className="text-sm font-semibold text-slate-900">
                  {initialData.contactNumber || 'N/A'}
                </p>
              </div>
              ...
              <div className="space-y-1">
                <p className="text-xs font-semibold uppercase tracking-wider text-slate-400">Office Address</p>
                <p className="text-sm font-semibold text-slate-900">
                  {initialData.officeAddress || 'N/A'}
                </p>
              </div>
            </div>
          </div>
...
export { DepartmentDetailsDialog };
