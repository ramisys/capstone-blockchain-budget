      ...
      <div className="p-6 max-w-3xl mx-auto my-12 animate-fade-in">
        <div className="bg-white border border-slate-200/90 rounded-2xl p-8 sm:p-12 text-center shadow-sm space-y-5">
          ...
          <div className="space-y-2 max-w-md mx-auto">
            <h2 className="text-[var(--font-size-2xl)] font-bold text-slate-900 tracking-tight">Access Denied</h2>
            <p className="text-[var(--font-size-sm)] text-slate-500">
    ...
    return (
      <div className="p-4 sm:p-6 lg:p-8 max-w-3xl mx-auto my-10 animate-fade-in">
        <div className="bg-white border border-slate-200/90 rounded-2xl p-8 sm:p-12 text-center shadow-sm space-y-6">
          ...
          <div className="space-y-2 max-w-md mx-auto">
            <h2 className="text-[var(--font-size-3xl)] font-extrabold text-slate-900 tracking-tight">User Not Found</h2>
            <p className="text-[var(--font-size-sm)] text-slate-500 leading-relaxed">
  ...
  return (
    <div className="p-4 sm:p-6 lg:p-8 max-w-6xl mx-auto space-y-8 animate-fade-in">
      <header className="space-y-4">
        <nav aria-label="Breadcrumb" className="flex items-center text-[var(--font-size-xs)] font-medium text-slate-500">
          ...
          {isAdmin && (
            <div className="flex items-center gap-3 pt-2 md:pt-0">
              <Button
                ...
                className="inline-flex items-center gap-2 px-4 py-2 text-[var(--font-size-sm)] font-medium rounded-xl border-slate-300 hover:bg-slate-50 hover:text-slate-900 transition-all duration-200"
              ...
              <Tooltip text={id === user?.id ? "You cannot delete your own account" : "Delete user account"}>
                <Button
                  ...
                  loading={deleting}
                  className={`inline-flex items-center gap-2 px-4 py-2 text-[var(--font-size-sm)] font-medium rounded-xl border transition-all duration-200 ${
                    id === user?.id
      ...
      <Card className="p-6 sm:p-8 bg-white border border-slate-200/90 rounded-2xl shadow-sm relative overflow-hidden transition-all">
        ...
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-6 relative z-10">
          <Avatar
            ...
            size="lg"
            className="w-20 h-20 sm:w-24 sm:h-24 text-[var(--font-size-3xl)] sm:text-[var(--font-size-4xl)] font-extrabold ring-4 ring-slate-100 shadow-md"
          />
          ...
          <div className="space-y-3 text-center sm:text-left flex-1 min-w-0">
            <div>
              ...
              <p className="text-[var(--font-size-sm)] font-medium text-slate-500 flex items-center justify-center sm:justify-start gap-1.5 pt-1">
            ...
            <div className="flex flex-wrap items-center justify-center sm:justify-start gap-2.5 pt-1">
              <RoleBadge role={userData.role} className="px-3 py-1 text-[var(--font-size-xs)]" />
              <StatusBadge status={userData.status} className="px-3 py-1 text-[var(--font-size-xs)]" />
              <span className="inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[var(--font-size-xs)] font-medium bg-slate-100 text-slate-600 border border-slate-200/80">
      ...
      <section aria-label="Account Statistics" className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-5 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <span className="text-[var(--font-size-xs)] font-semibold text-slate-500 uppercase tracking-wider">Created Date</span>
            <div className="w-8 h-8 rounded-lg bg-blue-50 text-blue-600 flex items-center justify-center">
              <Calendar className="w-4 h-4" />
            </div>
          </div>
          <p className="text-lg font-bold text-slate-900 mt-2">{formatDate(userData.createdAt)}</p>
          <p className="text-[var(--font-size-xs)] text-slate-400 mt-0.5">Account registration date</p>
        </Card>

        <Card className="p-5 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <span className="text-[var(--font-size-xs)] font-semibold text-slate-500 uppercase tracking-wider">Last Updated</span>
            <div className="w-8 h-8 rounded-lg bg-purple-50 text-purple-600 flex items-center justify-center">
              <Clock className="w-4 h-4" />
            </div>
          </div>
          <p className="text-lg font-bold text-slate-900 mt-2">{formatDate(userData.updatedAt)}</p>
          <p className="text-[var(--font-size-xs)] text-slate-400 mt-0.5">Profile state modified</p>
        </Card>

        <Card className="p-5 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <span className="text-[var(--font-size-xs)] font-semibold text-slate-500 uppercase tracking-wider">User ID</span>
            <button
          ...
          <p className="text-[var(--font-size-sm)] font-mono font-bold text-slate-800 mt-2 truncate">{truncatedId}</p>
          <p className="text-[var(--font-size-xs)] text-slate-400 mt-0.5">Unique system UUID</p>
        </Card>

        <Card className="p-5 bg-white border border-slate-200/80 rounded-2xl shadow-sm hover:shadow-md transition-shadow">
          <div className="flex items-center justify-between">
            <span className="text-[var(--font-size-xs)] font-semibold text-slate-500 uppercase tracking-wider">Account Type</span>
            <div className="w-8 h-8 rounded-lg bg-emerald-50 text-emerald-600 flex items-center justify-center">
              <ShieldCheck className="w-4 h-4" />
            </div>
          </div>
          <p className="text-lg font-bold text-slate-900 mt-2 truncate">{userData.role || 'Standard'}</p>
          <p className="text-[var(--font-size-xs)] text-slate-400 mt-0.5">System permission level</p>
        </Card>
      </section>
          ...
          <Card className="bg-white border border-slate-200/90 rounded-2xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[var(--font-size-base)] font-bold text-slate-900">User Information</h3>
              </div>
              <span className="text-[var(--font-size-xs)] text-slate-400 font-medium">Account Details</span>
            </div>

            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                <div className="flex items-center gap-2 text-slate-500 text-[var(--font-size-xs)] font-semibold uppercase tracking-wider mb-1">
                  <User className="w-3.5 h-3.5 text-indigo-500 shrink-0" />
                  <span>Full Name</span>
                </div>
                <p className="text-[var(--font-size-sm)] font-semibold text-slate-900">{userData.fullName || '—'}</p>
              </div>
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-[var(--font-size-sm)] font-semibold text-slate-900 truncate">{userData.email || '—'}</p>
              </div>

              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                <div className="flex items-center gap-2 text-slate-500 text-[var(--font-size-xs)] font-semibold uppercase tracking-wider mb-1.5">
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-[var(--font-size-sm)] font-semibold text-slate-900">{formatDate(userData.createdAt)}</p>
              </div>
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-[var(--font-size-sm)] font-semibold text-slate-900">{formatDate(userData.updatedAt)}</p>
              </div>

              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                <div className="flex items-center justify-between mb-1">
                  <div className="flex items-center gap-2 text-slate-500 text-[var(--font-size-xs)] font-semibold uppercase tracking-wider">
                ...
                <p className="text-[var(--font-size-sm)] font-medium text-slate-500 italic">General / Unassigned</p>
              </div>
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-[var(--font-size-sm)] font-mono font-medium text-slate-700">
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-[var(--font-size-sm)] font-medium text-slate-500 italic">Not Provided</p>
              </div>
              ...
              <div className="bg-slate-50/70 p-4 rounded-xl border border-slate-200/60 hover:bg-slate-50 transition-colors">
                ...
                <p className="text-[var(--font-size-sm)] font-medium text-slate-700">Recent (Active Session)</p>
              </div>
            </div>
          </Card>
          ...
          <Card className="bg-white border border-slate-200/90 rounded-2xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[var(--font-size-base)] font-bold text-slate-900">Security & Authentication</h3>
              </div>
              <span className="text-[var(--font-size-xs)] bg-indigo-50 text-indigo-700 font-semibold px-2 py-0.5 rounded-md border border-indigo-200/60">
                Protected
              </span>
            </div>
            ...
            <div className="p-6 grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div className="p-4 rounded-xl border border-slate-200/60 bg-white">
                ...
                <div className="flex items-center justify-between">
                  <span className="text-[var(--font-size-sm)] font-mono text-slate-700 tracking-widest">••••••••</span>
                  <span className="text-[var(--font-size-xs)] text-slate-400 font-medium">Encrypted</span>
                </div>
              </div>
              ...
              <div className="p-4 rounded-xl border border-slate-200/60 bg-white">
                ...
                <span className="text-[var(--font-size-sm)] font-medium text-slate-600">Not Available</span>
              </div>
              ...
              <div className="p-4 rounded-xl border border-slate-200/60 bg-white">
                ...
                <span className="text-[var(--font-size-xs)] font-semibold inline-flex items-center px-2 py-0.5 rounded-full bg-slate-100 text-slate-600 border border-slate-200">
                  Not Configured
                </span>
              </div>
              ...
              <div className="p-4 rounded-xl border border-slate-200/60 bg-white">
                ...
                <span className="text-[var(--font-size-xs)] font-semibold inline-flex items-center px-2 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200">
                  Active Session
                </span>
              </div>
            </div>
          ...
          <Card className="bg-white border border-slate-200/90 rounded-2xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[var(--font-size-base)] font-bold text-slate-900">Account Activity</h3>
              </div>
              <span className="text-[var(--font-size-xs)] text-slate-400 font-medium">Timeline</span>
            </div>
              ...
              <ol className="relative border-l border-slate-200 space-y-6 ml-3">
                <li className="ml-6">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[var(--font-size-sm)] font-bold text-slate-900">User account created</p>
                    <p className="text-[var(--font-size-xs)] text-slate-500">{formatFullDateTime(userData.createdAt)}</p>
                    <p className="text-[var(--font-size-xs)] text-slate-600 pt-1">
                ...
                <li className="ml-6">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[var(--font-size-sm)] font-bold text-slate-900">Account status verified</p>
                    <p className="text-[var(--font-size-xs)] text-slate-500">{formatDate(userData.createdAt)}</p>
                    <p className="text-[var(--font-size-xs)] text-slate-600 pt-1">
                ...
                <li className="ml-6">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[var(--font-size-sm)] font-bold text-slate-900">Last updated</p>
                    <p className="text-[var(--font-size-xs)] text-slate-500">{formatFullDateTime(userData.updatedAt)}</p>
                    <p className="text-[var(--font-size-xs)] text-slate-600 pt-1">
                ...
                <li className="ml-6">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[var(--font-size-sm)] font-bold text-slate-900">Password last changed</p>
                    <p className="text-[var(--font-size-xs)] text-slate-500">Not Available</p>
                    <p className="text-[var(--font-size-xs)] text-slate-600 pt-1">
                ...
                <li className="ml-6">
                  ...
                  <div className="space-y-0.5">
                    <p className="text-[var(--font-size-sm)] font-bold text-slate-900">Last login session</p>
                    <p className="text-[var(--font-size-xs)] text-slate-500">Recent</p>
                    <p className="text-[var(--font-size-xs)] text-slate-600 pt-1">
          ...
          <Card className="bg-white border border-slate-200/90 rounded-2xl shadow-sm overflow-hidden">
            <div className="px-6 py-4 border-b border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-2">
                ...
                <h3 className="text-[var(--font-size-base)] font-bold text-slate-900">Audit Information</h3>
              </div>
              <span className="text-[var(--font-size-xs)] text-slate-400 font-medium">Audit Trail</span>
            </div>

            <div className="p-6 space-y-4 text-[var(--font-size-sm)]">
